...
if os.getlogin()=='brad':
    ...
    os.chdir('/media/D43F-C3DF/PHYS297/Franck-Hertz/Analysis/')
else:
    os.chdir('/home/')
...
smoothed = pd.DataFrame(columns=['Va','Ic'], index=idx)
for i in temps:
    print("\n==================================================")
    ...
    for d in dirs:
        ...
        for v in vaic:
            ...
            x = bgc.funcSmoothFilt(winsize, wintype, winstdv, AllData.loc[i].loc[d][v], rollbak)
            smoothed.loc[i].loc[d][v] = x
